...
# on the command line we need to filter the VCF by position
# to save time and resources for the python processing
command = "bedtools intersect -a NA12878-NA12878-1-CEN-F-EGG5_markdup_recalibrated_Haplotyper.vcf -b HBOC_positions.bed -header > NA12878-NA12878-1-CEN-F-EGG5_markdup_recalibrated_Haplotyper_filteredPOS.vcf"
